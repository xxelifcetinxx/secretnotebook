...
window = Tk()
window.title("notebook for your secrets")
window.config(padx=30, pady=30)

canvas = Canvas(height=200, width=200)
logo = PhotoImage(file="note.png")
canvas.create_image(100,100,image=logo)
canvas.pack()

title_info_label = Label(text="Subject",font=("Arial",20,"normal"))
title_info_label.pack()

title_entry = Entry(width=30)
title_entry.pack()

input_info_label = Label(text="Special Notes",font=("Arial",20,"normal"))
input_info_label.pack()

input_text = Text(width=50, height=15)
input_text.pack()

master_secret_label = Label(text="Enter password",font=("Arial",20,"normal"))
